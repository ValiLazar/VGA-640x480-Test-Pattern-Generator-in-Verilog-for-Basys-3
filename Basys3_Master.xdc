...
##Pmod Header JA
##Sch name = JA1
set_property PACKAGE_PIN J1 [get_ports {Motion_detected}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {Motion_detected}]
##Sch name = JA2
...
##Pmod Header JB
##Sch name = JB1
set_property PACKAGE_PIN A14 [get_ports {io[0]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {io[0]}]
##Sch name = JB2
set_property PACKAGE_PIN A16 [get_ports {io[1]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {io[1]}]
##Sch name = JB3
set_property PACKAGE_PIN B15 [get_ports {io[2]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {io[2]}]
##Sch name = JB4
set_property PACKAGE_PIN B16 [get_ports {io[3]}]					
